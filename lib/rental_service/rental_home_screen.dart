...
class _RentalHomeScreenState extends State<RentalHomeScreen> {
  ...
  getBookedData() async {
    ...
    await _fireStoreUtils
        .getRentalBook(MyAppState.currentUser!.userID, false)
        .then((value) {
      setState(() {
        ordersList = value;
        isLoading = false;
  ...
  buildRides(RentalOrderModel orderModel) {
    ...
    totalAmount = ((double.parse(orderModel.subTotal!.toString()) +
                          ...
                          child: Column(
                            children: [
                              ...
                              buildUsersDetails(context,
                                  ...
                                  time: DateFormat('yyyy-MM-dd hh:mm a').format(
                                      orderModel.dropDateTime!.toDate())),
                            ],
                          ),
                        ),
                        const SizedBox(
                                    ...
                                    onPressed: () async {
                                      if (orderModel.pickupDateTime!
                                        ...
                                        MyAppState.currentUser!
                                                .rentalBookingDate =
                                            getDaysInBeteween(
                                                orderModel.pickupDateTime!
                                                    .toDate(),
                                                orderModel.dropDateTime!
                                                    .toDate());
                                        await FireStoreUtils.updateCurrentUser(
                                            MyAppState.currentUser!);
                                        ...
                                        final snack = SnackBar(
                                          content: Text(
                                            'You can start ride on your pickup date and time.'
                                                .tr(),
                                            style:
                                ...
                                Expanded(
                                  child: ElevatedButton(
                                    ...
                                    onPressed: () async {
                                      ...
                                      await FireStoreUtils
                                              .getRentalFirstOrderOrNOt(
                                                  orderModel)
                                          .then((value) async {
                                        if (value == true) {
                                          await FireStoreUtils
                                              .updateRentalReferralAmount(
                                                  orderModel);
                                        }
                                      });
                                      Map<String, dynamic> payLoad =
