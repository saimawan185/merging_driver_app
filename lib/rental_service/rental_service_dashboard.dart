...
import 'package:door_delights_driver/rental_service/add_driver_screen.dart';
import 'package:door_delights_driver/rental_service/rental_booking_screen.dart';
import 'package:door_delights_driver/rental_service/rental_home_screen.dart';
                          ...
                          Consumer<User>(builder: (context, user, _) {
                            return DrawerHeader(
                              child: Column(
                                ...
                                children: <Widget>[
                                  displayCircleImage(
                                      user.profilePictureURL, 70, false),
                                  Padding(
