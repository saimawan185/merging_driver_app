...
//   List<String> deliveryVehicleTypes = [
//     'Bike',
//     'Carriage',
//   ];

//   String? _selectedServiceType, _selectedDeliveryVehicleType;
...
//                         Padding(
//                           padding:
//                               EdgeInsets.only(top: 16.0, right: 8.0, left: 8.0),
//                           child: Container(
...
//                           focusedBorderColor: Color(COLOR_PRIMARY),
...
//         ),
//         Padding(
//           padding: const EdgeInsets.only(top: 22.0, right: 8.0, left: 8.0),
//           child: DropdownButtonFormField(
//             hint: Text('Please choose a vehicle type.'),
//             value: _selectedDeliveryVehicleType,
//             onChanged: (newValue) {
//               setState(() {
//                 _selectedDeliveryVehicleType = newValue.toString();
//               });
//             },
//             decoration: InputDecoration(
...
//                       BorderSide(color: Color(COLOR_PRIMARY), width: 2.0)),
//             ),
//             items: deliveryVehicleTypes.map((vehicle) {
//               return DropdownMenuItem(
...
//           if (_selectedDeliveryVehicleType == null) {
//             final snack = SnackBar(
//               content: Text(
//                 'Please select delivery vehicle type.'.tr(),
...
//       Constant.userModel!.lastOnlineTimestamp = Timestamp.now();
