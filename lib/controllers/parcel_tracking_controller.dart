    ...
    osmMarkers.add(
      flutterMap.Marker(
        ...
        child: CachedNetworkImage(
          width: 50,
          height: 50,
          imageUrl: Constant.sectionModelFor(orderModel.value.sectionId)!
              .markerIcon
              .toString(),
  ...
  Future<void> _loadIcons() async {
    if (Constant.selectedMapType == 'google') {
      ...
      driverIcon = BitmapDescriptor.fromBytes(
          Constant.sectionModelFor(orderModel.value.sectionId)?.markerIcon ==
                      null ||
                  Constant.sectionModelFor(orderModel.value.sectionId)
                          ?.markerIcon
                          ?.isEmpty ==
                      true
              ? await Constant()
