...
class ParcelOrderModel {
  ...
  factory ParcelOrderModel.fromJson(Map<String, dynamic> json) {
    print(
        'Value : ${json['id']} ${json['senderPickupDateTime']} ${json['senderPickupDateTime'].runtimeType}');
    ...
    return ParcelOrderModel(
      ...
      senderLatLong: json['senderLatLong'] != null
          ? UserLocation.fromJson(json['senderLatLong'])
          : UserLocation(),
      receiverLatLong: json['receiverLatLong'] != null
          ? UserLocation.fromJson(json['receiverLatLong'])
          : UserLocation(),
      sender: json['sender'] != null
          ? ParcelUserDetails.fromJson(json['sender'])
          : ParcelUserDetails(),
      receiver: json['receiver'] != null
          ? ParcelUserDetails.fromJson(json['receiver'])
          : ParcelUserDetails(),
      author:
          json.containsKey('author') ? User.fromJson(json['author']) : User(),
