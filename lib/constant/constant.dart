...
import 'package:door_delights_driver/models/currency_model.dart';
import 'package:door_delights_driver/models/language_model.dart';
...
import 'package:door_delights_driver/widget/permission_dialog.dart';
...
class Constant {
  ...
  static SectionModel? sectionModelFor(String? sectionId) =>
      sectionId != null && sectionId.isNotEmpty
          ? sectionModels[sectionId]
          : null;
  ...
  static String sectionNameFromId(String? sectionId) {
    ...
    return userModel?.serviceType ?? sectionId;
  }
