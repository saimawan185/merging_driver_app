...
import 'package:door_delights_driver/model/AddressModel.dart';
...
class OrderModel {
  ...
  factory OrderModel.fromJson(Map<String, dynamic> parsedJson) {
    ...
    return OrderModel(
      ...
      deliveryDiscount: double.parse(
        parsedJson['deliveryDiscount'] != null
            ? parsedJson['deliveryDiscount'].toString()
            : '0.0',
      ),
      serviceCharges: double.parse(
        parsedJson['serviceCharges'] == null
            ? '0.0'
            : parsedJson['serviceCharges'].toString(),
      ),
      authorID: parsedJson['authorID'] ?? '',
      createdAt: parsedJson['createdAt'] ?? Timestamp.now(),
      acceptedAt: parsedJson['acceptedAt'],
      reachedStoreAt: parsedJson['reachedStoreAt'],
      ...
      taxModel: taxList,
      preprationTime: parsedJson['estimatedTimeToPrepare'],
    );
  }
  ...
  Map<String, dynamic> toJson() {
    Map<String, dynamic> json = {
      ...
      'serviceCharges': this.serviceCharges ?? 0.0,
      ...
      "estimatedTimeToPrepare": preprationTime,
      'deliveredAt': deliveredAt,
      'acceptedAt': acceptedAt,
      'reachedStoreAt': reachedStoreAt,
    };
    if (this.driver != null) {
