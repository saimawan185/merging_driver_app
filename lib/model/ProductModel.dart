...
class ProductModel {
  ...
  ProductModel({
    ...
    this.extras_price = "",
    this.variant_info,
    this.scheduleBase = false,
    this.prescriptionRequired = false,
    this.loaderVehicle = false,
  });
  ...
  factory ProductModel.fromJson(Map<String, dynamic> parsedJson) {
    ...
    return new ProductModel(
      ...
      variant_info: (parsedJson.containsKey('variant_info') &&
          ...
          : null,
      prescriptionRequired: parsedJson['prescriptionRequired'] ?? false,
      loaderVehicle: parsedJson['loaderVehicle'] ?? false,
      scheduleBase: parsedJson['scheduleBase'] ?? false,
    );
  }
