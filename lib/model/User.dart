...
class User with ChangeNotifier {
  ...
  User({
    ...
    this.sectionId,
        ...
        this.appIdentifier =
            'DoorDelights Driver App ${Platform.operatingSystem}',
  ...
  factory User.fromJson(Map<String, dynamic> parsedJson) {
    ...
    return User(
        ...
        paymentCutomerId: parsedJson['paymentCutomerId'] ?? '',
  ...
  Map<String, dynamic> toJson() {
    Map<String, dynamic> json = {
      ...
      'ordercabRequestData': this.ordercabRequestData?.toJson(),
      'orderParcelRequestData': this.orderParcelRequestData?.toJson(),
      'paymentCutomerId': paymentCutomerId,
      'email': this.email,
