                  ...
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Container(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              ...List.generate(
                                  controller.order.value.taxSetting?.length ??
                                      0, (index) {
                                final taxModel =
                                    controller.order.value.taxSetting![index];
                                final taxTitle =
                        ...
                        controller.order.value.driver != null &&
                                    controller.order.value.driver!.ownerId !=
                                        null &&
                                    controller.order.value.driver!.ownerId!
                                        .isNotEmpty ||
