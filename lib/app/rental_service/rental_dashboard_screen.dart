...
import 'package:door_delights_driver/app/chat_screens/driver_inbox_screen.dart';
...
import 'package:door_delights_driver/app/rental_service/rental_home_screen.dart';
...
class RentalDashboardScreen extends StatelessWidget {
  ...
  Widget _buildHomeWithBottomNav(
      RentalDashboardController controller, BuildContext context) {
    ...
    final items = sections.map((section) {
      ...
      return BottomNavigationBarItem(
        icon: Icon(_getSectionIcon(flag)),
        label: _getSectionLabel(flag).tr(),
      );
    }).toList();
  ...
  String _getSectionLabel(String flag) {
    switch (flag) {
      case 'cab-service':
        return 'Cab';
  ...
  IconData _getSectionIcon(String flag) {
    switch (flag) {
      case 'cab-service':
  ...
  Widget _buildSectionWidget(String flag) {
    switch (flag) {
      case 'cab-service':
        return CabHomeScreen(refresh: () {});
      case 'parcel_delivery':
        return const ParcelHomeScreen();
      case 'rental-service':
