...
import 'package:door_delights_driver/app/rental_service/rental_booking_search_screen.dart';
...
import 'package:door_delights_driver/controllers/rental_home_controller.dart';
...
class RentalHomeScreen extends StatelessWidget {
                                  ...
                                  child: Column(
                                    children: [
                                      Obx(() {
                                        ...
                                        final controllerOwner =
                                            controller.ownerModel.value;

                                        final num wallet =
                                            user.walletAmount ?? 0.0;
                                        ...
                                        child: RefreshIndicator(
                                          ...
                                          child: ListView.builder(
                                            ...
                                            itemCount: controller
                                                .rentalBookingData.length,
                                            padding: EdgeInsetsGeometry.zero,
                                            itemBuilder: (context, index) {
                                              RentalOrderModel
                                                  rentalBookingData = controller
                                                      .rentalBookingData[index];
                                              return InkWell(
                                                onTap: () {
                                                  Get.to(
                                                      () =>
                                                                ...
                                                                children: [
                                                                  InkWell(
                                                                    onTap: () {
                                                                      if (rentalBookingData
                                                                              ...
                                                                              ?.phoneNumber !=
                                                                          null) {
                                                                        Constant.makePhoneCall(rentalBookingData
                                                                            .author!
                                                                            .phoneNumber!);
                                                                      }
                                                                    },
                                                                  ...
                                                                  InkWell(
                                                                    onTap:
                                                                      ...
                                                                      UserModel?
                                                                          customer =
                                                                          await FireStoreUtils.getUserProfile(rentalBookingData.authorID ??
                                                                              '');
                                                                      UserModel?
                                                                          driver =
                                                                          await FireStoreUtils.getUserProfile(rentalBookingData.driverId ??
                                                                              '');
                                                                ...
                                                                : rentalBookingData
                                                                    ...
                                                                    ? RoundedButtonFill(
                                                                        ...
                                                                        onPress:
                                                                            () async {
                                                                          controller
                                                                              .completeParcel(rentalBookingData);
                                                                        },
                                                                      )
                                                                    : RoundedButtonFill(
            ...
            child: Column(
              ...
              children: [
                ...
                RoundedButtonFill(
                  ...
                  onPress: () async {
                    if (controller
                            .currentKilometerController.value.text.isEmpty ||
                    ...
                    rentalBookingData.startKitoMetersReading =
                        controller.currentKilometerController.value.text.trim();
  ...
  void setFinalKilometerDialog(BuildContext context, bool isDark,
      RentalHomeController controller, RentalOrderModel rentalBookingData) {
    Get.dialog(
      Dialog(
        shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(20)),
        backgroundColor: isDark
                  ...
                  onPress: () async {
                    if (controller
                      ...
                      return;
                            ...
                            .toString()
                            .trim()) <
                        double.parse(rentalBookingData.startKitoMetersReading
                            .toString())) {
                      ShowToastDialog.showToast(
  ...
  void conformCashPayment(BuildContext context, bool isDark,
      RentalHomeController controller, RentalOrderModel rentalBookingData) {
    Get.dialog(
      Dialog(
        shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(20)),
