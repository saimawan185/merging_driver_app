...
import 'package:door_delights_driver/app/chat_screens/full_screen_image_viewer.dart';
import 'package:door_delights_driver/app/chat_screens/full_screen_video_viewer.dart';
...
import 'package:door_delights_driver/controllers/chat_controller.dart';
          ...
          return Scaffold(
            appBar: AppBar(
                ...
                bottom: PreferredSize(
                    preferredSize:
                        Size.fromHeight(10), // height of the bottom section
                    child: Padding(
  ...
  Widget chatItemView(bool isDark, bool isMe, ConversationModel data) {
    return Container(
      padding: EdgeInsets.only(
          left: isMe ? 80 : 10, right: isMe ? 10 : 80, top: 10, bottom: 10),
      child: isMe
          ? Align(
          ...
          onPressed: () async {
            ...
            try {
              ...
              if (image != null) {
                ...
                controller.sendMessage(
                    controller.messageController.value.text, url, '', 'image');
              }
            } catch (e) {
