                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            ...List.generate(
                                ...
                                (index) {
                              return _summaryTile(
                                  "${controller.cabOrder.value.taxModel![index].title} ${controller.cabOrder.value.taxModel![index].type == 'fix' ? '' : '(${controller.cabOrder.value.taxModel![index].tax}%)'}",
                                  Constant.amountShow(
