import 'package:door_delights_driver/app/owner_screen/driver_create_screen.dart';
import 'package:door_delights_driver/app/owner_screen/view_all_drivers.dart';
import 'package:door_delights_driver/constant/constant.dart';
import 'package:door_delights_driver/controllers/owner_dashboard_controller.dart';
import 'package:door_delights_driver/controllers/owner_home_controller.dart';
            ...
            return Scaffold(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              RoundedButtonFill(
                                ...
                                onPress: () {
                                  OwnerDashboardController dashBoardController =
                                  ...
                                  children: [
                                    Expanded(
                                      child: Container(
                                        decoration: BoxDecoration(
                                          color:
                                              AppThemeData.homePageGradiant[0],
                                          borderRadius:
                                              BorderRadius.circular(10),
                                        ),
                                        child: Padding(
                                          ...
                                          child: Column(
                                            ...
                                            children: [
                                              ...
                                              Text(
                                                controller.totalRidesAllDrivers
                                                    .toString(),
                                                textAlign: TextAlign.center,
                                                style:
                                    ...
                                    Expanded(
                                      child: Container(
                                        decoration: BoxDecoration(
                                          color:
                                              AppThemeData.homePageGradiant[1],
                                          borderRadius:
                                              BorderRadius.circular(10),
                                        ),
                                        child: Padding(
              ...
              floatingActionButton:
                  (Constant.userModel?.isDocumentVerify == true &&
                              Constant.userModel?.isAutoVerify == false) ||
                          Constant.userModel?.isAutoVerify == true
                      ? ClipOval(
