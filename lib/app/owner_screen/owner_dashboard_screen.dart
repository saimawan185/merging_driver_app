...
import 'package:door_delights_driver/app/owner_screen/driver_location_screen.dart';
import 'package:door_delights_driver/app/owner_screen/owner_home_screen.dart';
            ...
            appBar: AppBar(
              ...
              actions: [
                InkWell(
                    ...
                    child:
                        SvgPicture.asset("assets/icons/ic_location_pin.svg")),
                const SizedBox(
                  width: 14,
                ),
                Visibility(
