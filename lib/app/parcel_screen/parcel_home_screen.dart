...
// ─── FIX: Use TickerProviderStateMixin instead of SingleTickerProviderStateMixin ──
class _ParcelHomeScreenState extends State<ParcelHomeScreen>
          ...
          children: [
            ...
            Expanded(
              child: GoogleMap(
                ...
                myLocationEnabled:
                    // _driverModel!.inProgressOrderID != null ? false :
                    true,
  ...
  void _animateDriverMarker({
    ...
    _markerAnimationController = AnimationController(
      vsync: this, // now safe with TickerProviderStateMixin
