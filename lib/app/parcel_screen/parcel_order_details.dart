...
class ParcelOrderDetails extends StatelessWidget {
                      ...
                      Container(
                        ...
                        child: Column(
                          ...
                          children: [
                                ...
                                Column(
                                  children: [
                                    ...
                                    DottedBorder(
                                      ...
                                      child:
                                          const SizedBox(width: 20, height: 95),
                                    ),
                                    Image.asset(
                                        "assets/images/image_parcel.png",
                                        height: 32,
                              ...
                              children: [
                                ...
                                Row(
                                  children: [
                                    ...
                                    if (controller.getSelectedCategory()?.image !=
                                            null &&
                                        controller
                                            .getSelectedCategory()!
                                            .image!
                            ...
                            controller.parcelOrder.value.parcelImages == null ||
                                    controller
                                        .parcelOrder.value.parcelImages!.isEmpty
                                ? SizedBox()
                                : SizedBox(
                                    height: 120,
                                    child: ListView.builder(
                                      itemCount: controller.parcelOrder.value
                                          .parcelImages!.length,
                                      shrinkWrap: true,
                                        ...
                                        return Padding(
                                          ...
                                          child: ClipRRect(
                                            ...
                                            child: NetworkImageWidget(
                                              imageUrl: controller.parcelOrder
                                                  .value.parcelImages![index],
                                              width: 100,
                                              fit: BoxFit.cover,
                                              borderRadius: 10,
                                            ),
                                  ...
                                  children: [
                                    Row(
                                      children: [
                                        ...
                                        SizedBox(width: 20),
                                        Text(
                                          controller.parcelOrder.value.author
                                                  ?.fullName() ??
                                              '',
                                          style: AppThemeData.boldTextStyle(
                                              color: isDark
                      ...
                      Container(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            ((controller.parcelOrder.value.driver?.ownerId !=
                                            null &&
                                        (controller.parcelOrder.value.driver
                                                ?.ownerId?.isNotEmpty ??
                                            false)) ||
  ...
  Widget _infoSection(
      String title, String name, String address, String phone, bool isDark) {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        Text(title,
