...
import 'package:door_delights_driver/controllers/parcel_search_controller.dart';
...
import 'package:door_delights_driver/widget/osm_map/map_picker_page.dart';
import 'package:door_delights_driver/widget/osm_map/place_model.dart';
import 'package:door_delights_driver/widget/place_picker/location_picker_screen.dart';
                                      ...
                                      child: Container(
                                        ...
                                        child: Column(
                                          ...
                                          children: [
                                            ...
                                            if (parcelBookingData.isSchedule ==
                                                true)
                                              SizedBox(
                                                height: 12,
                                              ),
                                              ...
                                              onPress: () async {
                                                final hasOwner = controller
                                                    ...
                                                    controller.driverModel.value
                                                        .ownerId!.isNotEmpty;
                                                if (hasOwner) {
                                                  final ownerWallet = controller
                                                          .ownerModel
                                                          .value
                                                          .walletAmount ??
                                                      0.0;
                                                  final minOwnerDeposit =
